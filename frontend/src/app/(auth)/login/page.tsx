      ...
      <Card className="relative w-full max-w-[400px] border-border shadow-lg">
        <CardHeader className="text-center space-y-3 pb-2 pt-8">
          ...
          <div className="space-y-1">
            <CardTitle className="text-lg font-semibold tracking-tight">{t("auth.welcomeBack")}</CardTitle>
            <CardDescription className="text-[13px]">{t("auth.signInTo")}</CardDescription>
          </div>
        </CardHeader>
